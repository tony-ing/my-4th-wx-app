...
33. 之前做的弹窗功能有诸多问题。现在我们重新开始设计。首先点击activity-item之后，从数据库获取具体activity的详细信息，并获取到description字段。之后展示弹窗，弹窗中要展示活动标题，时间地点，以及description字段的内容。


34. 很好，现在我们来微调弹窗的样式。首先我希望弹窗的高度能够占屏幕的70%，这样能有更多的空间能显示弹窗中的description。

35. 很好，接下来我们要在弹窗下方，也就是description的下方，增加一个"立即报名"的按钮。用户点击此按钮，会跳转到一个新的报名页面。我们先暂时不写报名页面，先把这个按钮添加进去，预留好接口。
